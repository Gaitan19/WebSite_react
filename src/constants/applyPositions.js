export const countryOptions = [
  ...
  { value: "CC", label: "Cocos Islands", dialCode: "+61" },
  ...
  { value: "CW", label: "Curacao", dialCode: "+599" },
  ...
  { value: "TL", label: "East Timor", dialCode: "+670" },
  ...
  { value: "CI", label: "Ivory Coast", dialCode: "+225" },
  ...
  { value: "MK", label: "Macedonia", dialCode: "+389" },
  ...
  { value: "AN", label: "Netherlands Antilles", dialCode: "+599" },
  ...
  { value: "CG", label: "Republic of the Congo", dialCode: "+242" },
  { value: "RE", label: "Reunion", dialCode: "+262" },
  { value: "RO", label: "Romania", dialCode: "+40" },
  { value: "RU", label: "Russia", dialCode: "+7" },
  { value: "RW", label: "Rwanda", dialCode: "+250" },
  { value: "BL", label: "Saint Barthelemy", dialCode: "+590" },
  ...
  { value: "MF", label: "Saint Martin", dialCode: "+590" },
  ...
  { value: "VA", label: "Vatican", dialCode: "+379" },
...
export const inputTypes = ["text", "email", "tel", "select"];
...
export const fields = [
  {
    ...
    name: "name",
    placeholder: "Sofia",
    customClass: "careers__form-input",
  },
  {
    type: "text",
    name: "email",
...
export const fieldsSecondary = [
  ...
  },
  {
    ...
    customClass: "careers__form-multi",
    isMultiselect: true,
  },
  {
    type: "select",
    name: "english",
    placeholder: "English Level (Select an option)",
    options: englishLevelOptions,
    customClass: "careers__form-english",
  },
];
